...
@onready var download_button: TextureButton = $VBoxContainer/WallpaperPanel/Panel/MarginContainer/HBoxContainer/TextureButton
@onready var image_titel: Label = $VBoxContainer/WallpaperPanel/Panel/MarginContainer/HBoxContainer/Label
